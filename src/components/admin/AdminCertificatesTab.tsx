          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-sm print:hidden">
            <div className="bg-slate-900 border border-slate-700 rounded-3xl p-6 w-full max-w-4xl shadow-2xl space-y-6 max-h-[92vh] overflow-y-auto">
              <div className="flex items-center justify-between border-b border-slate-800 pb-3">
                ...
                <div className="flex items-center gap-2">
                  <button
                    onClick={() => printCertificateElement('admin-certificate-card', previewCert.certificate_code)}
              ...
              <div
                id="admin-certificate-card"
                className="certificate-dark-print-target relative rounded-2xl bg-slate-950 border-2 border-slate-800 p-8 sm:p-10 shadow-2xl overflow-hidden text-center space-y-6 box-border"
              >
                {/* Tech Highlights */}
